...
elsif ap_xor_bp = "0001" then permuted_input(7 downto 4) <= "1010"; -- A
elsif ap_xor_bp = "0010" then permuted_input(7 downto 4) <= "0101"; -- 5
elsif ap_xor_bp = "0011" then permuted_input(7 downto 4) <= "1110"; -- E
elsif ap_xor_bp = "0100" then permuted_input(7 downto 4) <= "0110"; -- 6
elsif ap_xor_bp = "0101" then permuted_input(7 downto 4) <= "1101"; -- D
elsif ap_xor_bp = "0110" then permuted_input(7 downto 4) <= "1001"; -- 9
elsif ap_xor_bp = "0111" then permuted_input(7 downto 4) <= "0000"; -- 0
elsif ap_xor_bp = "1000" then permuted_input(7 downto 4) <= "1100"; -- C
elsif ap_xor_bp = "1001" then permuted_input(7 downto 4) <= "1000"; -- 8
elsif ap_xor_bp = "1010" then permuted_input(7 downto 4) <= "1111"; -- F
elsif ap_xor_bp = "1011" then permuted_input(7 downto 4) <= "0011"; -- 3
elsif ap_xor_bp = "1100" then permuted_input(7 downto 4) <= "0010"; -- 2
elsif ap_xor_bp = "1101" then permuted_input(7 downto 4) <= "0100"; -- 4
elsif ap_xor_bp = "1110" then permuted_input(7 downto 4) <= "0111"; -- 7
...
elsif befor_t3 = "0001" then permuted_input(3 downto 0) <= "0111"; -- 7
elsif befor_t3 = "0010" then permuted_input(3 downto 0) <= "1111"; -- F
elsif befor_t3 = "0011" then permuted_input(3 downto 0) <= "0100"; -- 4
elsif befor_t3 = "0100" then permuted_input(3 downto 0) <= "0001"; -- 1
elsif befor_t3 = "0101" then permuted_input(3 downto 0) <= "0010"; -- 2
elsif befor_t3 = "0110" then permuted_input(3 downto 0) <= "0110"; -- 6
elsif befor_t3 = "0111" then permuted_input(3 downto 0) <= "1110"; -- E
elsif befor_t3 = "1000" then permuted_input(3 downto 0) <= "1001"; -- 9
elsif befor_t3 = "1001" then permuted_input(3 downto 0) <= "1011"; -- B
elsif befor_t3 = "1010" then permuted_input(3 downto 0) <= "0011"; -- 3
elsif befor_t3 = "1011" then permuted_input(3 downto 0) <= "0000"; -- 0
elsif befor_t3 = "1100" then permuted_input(3 downto 0) <= "1000"; -- 8
elsif befor_t3 = "1101" then permuted_input(3 downto 0) <= "0101"; -- 5
elsif befor_t3 = "1110" then permuted_input(3 downto 0) <= "1100"; -- C
